    ...
    <div className="space-y-6 p-6 max-w-4xl mx-auto">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-300">
          Tezu AI - World's Most Secure & Private AI Assistant
        </p>
                ...
                <div key={key} className="flex items-center justify-between p-3 bg-gray-700/50 rounded">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      {key === 'dataCollection' && 'Control if Tezu can collect usage data for improvements'}
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                ...
                <div className="p-4 bg-yellow-500/10 border border-yellow-500/30 rounded">
                  ...
                  <p className="text-sm text-gray-300">Tezu AI never mines your data for commercial purposes</p>
                </div>
                <Button 
